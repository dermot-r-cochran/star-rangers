...
2. **Decide Path A or B**, then either delete the content directories above and write your own (Path A), or keep what you want and add to it (Path B — check `CONTENT-LICENSE.md`'s conditions as you go).
