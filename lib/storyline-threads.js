...
const STORYLINE_THREADS = [
  ...
  },
  {
    ...
    // it now is - on the line, in the open. The survey's answer is still his.
    // "Below the Roof" is a WORKING TITLE taken from the Fliade entry - the
    // survey's own word, Pandoid, cannot name a thread told from inside - and
    // is his to replace before the first chapter; the id follows the title.
    ...
    // children's edition, `below-the-roof` on roof.fianilchruinne.com (a
    // working host, 2026-09-07), extends `threads` from the children's floor.
    seasons: [11]
  },
  {
    id: "church-space",
