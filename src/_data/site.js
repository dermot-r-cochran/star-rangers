module.exports = function () {
  ...
  return {
    ...
    description: "Fian Ilchruinne is a multi-viewpoint novel of the Grand Ensemble Multiverse, hard science fiction with one licensed deviation: a station clock forty seconds wrong, and the Star Rangers ordered to measure the drift and guard the public record. The stars call us forward with hope; to protect what is good and to see what is true. One canonical history across the Five Layers and multiple Concordants.",
    url: `https://${domain}/`,
