...
id: tissadelle
species: Human
role: Cadet (Season 1) → Line Captain (Season 5)
status: Active
aliases:
  - "Shepherd"
  - "Tiss"
...
By Season 5, these qualities have become load-bearing. A Line Captain who will not send Rangers into situations she cannot defend is exactly what boundary-proximate deployments require.
...
She does not bring it up. She also does not leave the room when someone else does — which has gotten harder now that the anthem circulates well past the Corps. She has not played with Ashgrove and Calloway in years; a promotion track that outpaces her own cohort by a full season leaves no room for it, and she has never pretended otherwise. See [Slipwave](/star-rangers/glossary/slipwave/) for what the band became without her.
