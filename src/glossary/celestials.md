...
Their function is concrete: Celestials maintain Concordant-boundary integrity through lawful enforcement actions, acting within the scope delegated to them by Telearchs. The scale of that work is never smaller than a galaxy and usually wider; a single world falls inside a Celestial's attention only as part of a process that crosses it.
...
**The tier is graded within itself**, as the Levrils are, and it is one of only two Cascade strata that are. The grade is delegation: how broad a scope the Telearchs entrust a Celestial to act within. That is authority, not reach, since an action still reaches only as far as the operation it addresses. The grades are unnamed, and their number is not established. The retired designations *High Celestials* and *higher celestials* do not name it: both meant other tiers ([High Celestials](/star-rangers/glossary/high-celestials/)).
