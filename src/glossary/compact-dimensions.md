...
related:
  ...
  - "Concordant"
  - "The Interval"
tags: [compact-dimensions, dimensions, cosmology, common-manifold, etheric]
---

**Compact dimensions** are the spatial dimensions of a universe that exist at every point but are wound too tightly for anything at Material scale to move along or look down. Our home universe has seven of them, giving it a dimensional floor of eleven: three extended spatial dimensions, seven compact, and one of time.
...
**Example:** Elvira's chalk and thread work is done entirely in three extended dimensions, on ground she can stand on. The structure she is reading has extent through seven she cannot — which is why the work is procedural mapping rather than direct observation, and why she must test a boundary rather than simply look at one.

See also: [Etheric](/star-rangers/glossary/etheric/), [The Common Manifold](/star-rangers/lore/post-eleven-dimensional-manifold/), [The Grand Ensemble Multiverse](/star-rangers/lore/ensemble-multiverse/), [The Five Layers of Reality](/star-rangers/lore/five-layers/).
