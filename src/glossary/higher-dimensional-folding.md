...
**Example:** A fold transit briefly draws two distant regions into adjacency, opens a stable aperture just long enough for a vessel to cross, and then releases — leaving no shortcut behind and no trace that the two regions were ever brought close. The vessel arrives; the space itself does not remain folded.
