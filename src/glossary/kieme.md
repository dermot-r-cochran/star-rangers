...
Two further threads in the codex record attach to Kieme without settling anything. First, the [Avatar](/star-rangers/glossary/avatar/) exception permits, in theory, even Kieme to have incarnated as a limited person — like Kieme, without being the same person as Kieme, and leaving a record indistinguishable from a Champion's. Second, the codex speaks of a **subtle influence of Kieme, known there as The Holy Spirit** — neither avatar nor intervention, harder to define and explain than either, and precisely the kind of influence the invariant-only inference method this glossary insists on would be structurally unable to detect. See [Timeless and Immanent](/star-rangers/lore/cosmic-cascade/) in the Cascade lore entry for both.
