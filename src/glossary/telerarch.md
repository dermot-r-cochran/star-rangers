...
**Telearch** (pronounced: **TEL-ee-ark**; plural: **Telearchs**) is the Cascade tier that sits below Worldwrights in the fixed hierarchy, above the [Dynarchs](/star-rangers/glossary/dynarch/) and [Celestials](/star-rangers/glossary/celestials/).
...
The retired legacy designation **High Celestials** most often meant this tier — though older records also used "higher celestials" for the force-governing [Dynarchs](/star-rangers/glossary/dynarch/), which is why the term was retired as ambiguous; see [High Celestials](/star-rangers/glossary/high-celestials/) for the disambiguation rule. The correct current spelling is **Telearch**; earlier records may also use *Telerarch*.
...
The [Dynarchs](/star-rangers/glossary/dynarch/) — the tier that encapsulates and governs physical forces — are aligned with the Telearchs: force-continuity obligations run up the Telearch line, not through a universe's resident governance.
