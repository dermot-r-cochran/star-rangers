...
This is why the Authority's plural and singular forms are both ordinary rather than exceptional: a Council reaching decisions through a [Consensus Field](/star-rangers/lore/glossary/canonical-glossary-and-migration-guide/), and a founder presiding over one, are the same institution seen from two angles. Plural formations descended from a seed mind — Synarch Minds among them — occupy the founder's seat as a single presiding member, not as a rival council.

**On what "answer to" means here.** A Principal answers to its universe's Authority, and that Authority is the body the Principal sits in. This is subordination to a council, not to a superior being: the Council holds a universe-wide remit no single Harmonarch has, and binds each of its members within their own zone. A Principal outvoted in council is still bound by it.
