...
### The Uachtarán, and the Garda an Uachtaráin

The rotating council has a presiding member, and that office is the nearest thing the Union has to a head of state: the **Uachtarán** — *President*, in the Irish the charter was drafted in — who presides when the council sits and speaks for the Union to the worlds outside it. The office carries no executive power, which is the only way a charter with no Union-wide executive could have a president at all: an Uachtarán convenes, presides, receives and speaks for, and cannot direct a member world in anything. How the office passes from one holder to the next, and for how long, the record has not established.

The Uachtarán's protection is the **Garda an Uachtaráin** — the President's Guard — the Union's presidential protection unit, and the one standing formation of a military that is otherwise mostly ceremonial. It is small, it goes where the Uachtarán goes, and its work is protection rather than ceremony, which sets it apart from the honour escort the Highland Guard provides under Union protocol. Where its members are drawn from, and for how long they serve, the record has likewise not established. What the charter rules out is plain enough: the Garda an Uachtaráin is not a Union police, because the charter leaves law to each world, and it never polices anyone — it protects one office and nothing else.
