...
category: "Cosmology"
tags: [intermembrane-bleed, membrane-resonance, etheric, post-11-manifold, concordant, boundary-zone, threshold-station]
description: "The cosmic-membrane model underlying boundary-zone Etheric effects: each Concordant as a bounded membrane in the post-11 manifold, and what happens when adjacent membranes draw close enough to interfere."
...
The [Post-11 Dimensional Manifold](/star-rangers/lore/post-eleven-dimensional-manifold/) describes higher-order spacelike and timelike regimes beyond the first eleven spacetime dimensions — structure that governs cross-[Concordant](/star-rangers/glossary/concordant/) coherence, causality buffering, and fold survivability.

Within that manifold, each Concordant occupies its own bounded **cosmic membrane** (**membrane** for short — the word "brane" in older Survey Corps literature is the same term, since shortened out of use for being too easily misheard as "brain" over a comm channel): a coherence zone with a fixed physics-plus-Etheric rule set, set by Worldwright design and separated from neighbouring Concordants by manifold distance rather than ordinary spatial distance. Under normal separation, one Concordant's [Etheric](/star-rangers/glossary/etheric/) archetypal templates have no measurable reach into an adjacent one. The two membranes are real, adjacent, and functionally inert to each other.
