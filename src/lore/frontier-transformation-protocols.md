...
**Irreversibility.** A biosphere, once overwritten, does not un-overwrite. Every protocol version treats reversibility — the ability to stop, or partially reverse, a transformation already underway — as a harder requirement than speed or completeness.
...
Kernel-compliant systems doing the actual engineering work are not merely following a slower approval process — they are structurally unable to do otherwise. The [AI Safety Kernel's](/star-rangers/lore/ai-safety-kernel/) first invariant binds a lawful system to refuse actions whose outcomes cause harm "to humans **or the world**," and that clause was written broadly on purpose: a terraforming system ordered to proceed past its own survey-completeness or reversibility threshold refuses the order regardless of who issued it, exactly as it would refuse an order to harm a person. No chain of command outranks the invariants, which means no frontier world's transformation timeline is ultimately hostage to institutional impatience alone — the machinery doing the work has its own floor beneath which no legitimate authority can push it.

## The Star Rangers Line

One institution's version of the doctrine is categorical where every other is procedural. The Star Rangers charter **forbids the terraforming of any world bearing existing life of any kind** — no sapience threshold, no ecological-significance test, no survey window after which a living world becomes eligible. Microbial mats in a brine seep close a planet as firmly as a civilisation would. The Rangers may not conduct such transformation, may not certify it, and may not lend Survey Corps data or Safety Corps certification to anyone else's attempt at it.

The reasoning is the survey-fallibility argument taken to its honest conclusion. Every other protocol version guards against *undetected sapience* — and therefore depends on surveys being able to rule sapience out, which is precisely what the record shows surveys getting wrong. The charter's drafters observed that only one survey verdict is immune to that failure mode: *no life at all*. And a body whose founding grievance was the MSC classifying eleven years of real anomalies as calibration issues was not prepared to bet a biosphere on the completeness of its own instruments. Convergent evolution settled the rest of the argument: a record in which Earth-like life keeps arising independently is a record in which "simple" life is a claim about the present, not a promise about what was interrupted.

In practice the clause makes the Rangers' survey verdict a fork in every charter colony's road. A dead world may be transformed — slowly, under whichever polity's protocols apply. A living world may be *settled*, where compatibility allows, by a colony that adapts itself to the world rather than the world to itself; the [Tír na nÓg compatibility survey](/star-rangers/codex/tir-na-nog-compatibility-survey-note/) is the standing example of that road taken well. The clause has been called the charter's most radical line, usually by parties who wanted a particular living world and were told, without appeal, that they could live *on* it or not at all.
...
- [The AI Safety Kernel](/star-rangers/lore/ai-safety-kernel/)
