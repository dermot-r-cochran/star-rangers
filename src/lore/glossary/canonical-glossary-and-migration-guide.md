...
- **Classification Rule:** Graded within the tier (ruled 2026-09-23), the grades unnamed and marked as an absence. Only Celestials and Levrils are ranked within their strata; every other stratum differs by domain or function, and Champions are unranked. Never name a Celestial grade *High* or *higher Celestial*: both are retired designations for other tiers.
