...
title: "Post-Teleport Ascension Stress Disorder"
category: "Medicine"
...
image_alt: "A surgical robot in an operating room"
---
...
Medical Corps and Safety Corps findings agree on this much: PTASD is a lawful physiological response to a lawful physical event, not evidence of anything supernatural reaching a patient. No Cascade tier communicates with, selects, or intervenes on behalf of a jumper — the [Cosmic Cascade](/star-rangers/lore/cosmic-cascade/)'s own constraints forbid it, and PTASD is not treated as an exception.

The working hypothesis, still contested between the two corps, is that a teleport lock executed where [Etheric](/star-rangers/glossary/etheric/) templates are already under boundary-zone stress briefly couples a jumper's cognition to archetypal interference at a density ordinary transit never produces. Nothing is communicated across that coupling. Nothing needs to be, for a nervous system to register that it brushed a structure it has no frame for holding, the same way a retina registers a light it cannot resolve into an image. The patient did not perceive a Telearch. The patient's instruments — biological, in this case — recorded scale without content, and came back changed by the recording.
...
- [Teleportation Constraints](/star-rangers/lore/teleportation-limitations/)
- [Boundary Zones and Concordant Edges](/star-rangers/lore/boundary-zones/)
- [Etheric](/star-rangers/glossary/etheric/)
- [The Cosmic Cascade](/star-rangers/lore/cosmic-cascade/)
