...
**Tír Tairngire** — Irish for "the Land of Promise," a distinct Otherworld name from the one [Tír na nÓg](/star-rangers/lore/planets/tir-na-nog/) already borrowed for the Celtic Union's own flagship world — is a primary universe under its own Worldwright, independent in design and lineage from Tír na nÓg's Concordant. The shared mythic register is coincidence of naming convention, not evidence of shared origin, the same caution [Concordant Membranes](/star-rangers/lore/concordant-membranes/) already applies to any two membranes that happen to resemble each other.

Its cosmic membrane sits close enough to Tír na nÓg's own, in the post-11 manifold, that the separation between them does not settle into a fixed Boundary-State Class the way most documented boundary zones do. Instead it cycles — narrowing toward a Class II Oscillatory Interface, holding there, widening back toward Class I — on a rhythm regular enough that four centuries of Union sky-watching correlate it, loosely but consistently, with Tír na nÓg's own **Conjunction**, when Cliona's shadow crosses Donn's face. Survey Corps has not confirmed the two phenomena share a mechanism, only that they share a calendar. This is filed as a working hypothesis, not settled physics, and specifically *not* offered as a seventh answer to Tír na nÓg's own compatibility anomaly — a correlated crossing window explains nothing about carbon chemistry, and the [existing six theories](/star-rangers/codex/tir-na-nog-compatibility-survey-note/) stand unchanged.
...
Beings native to Tír Tairngire's own Concordant — the **[Caomhari](/star-rangers/glossary/caomhari/)** in the official record, *the Good People* in the Union's own telling, and elves in off-world speech — cross bodily during the window and, in every account on record, withdraw again before it closes. Classified under [Meta-Dimensional Beings](/star-rangers/lore/meta-dimensional-beings/) as Class II — sapient, without Cascade standing — they are the clearest documented case that not every Class II being is a predator: no crossing has ever produced a confirmed feeding signature, a residue, or a debt of the kind [Predatory Entities](/star-rangers/lore/predatory-entities/) catalogues. They are simply from somewhere else.
...
At the window they are luminous, and the First Landing records' phrase for them — [*Luminescent Ethereal Beings*](/star-rangers/glossary/luminescent-ethereal-beings/) — is kept for that reason. The light is their own: a body built in Filinesse's envelope carries its coupling of sound and light, which holds on this side only while the Harmonic Membrane's templates are winning local admissibility at the tunnel, so the glow rises with the window and dies with it. The glossary entry states the bounds and the instrument reading; nothing there is licensed that this page and the [Intermembrane Bleed](/star-rangers/glossary/intermembrane-bleed/) entry did not already hold.

## The Interior: Filinesse

No instrument has ever crossed, so everything known of Tír Tairngire's inside comes through two apertures: what witnesses have seen through the open tunnel during a Conjunction window, and the little, across four centuries of contact, that the Caomhari have let stand about their home. Both are thin. This section records only what they agree on.
