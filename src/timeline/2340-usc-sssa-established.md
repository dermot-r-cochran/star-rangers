...
<header class="lore-entry__header">
  <nav aria-label="Timeline location">
    <ol class="breadcrumb" role="list">
      ...
      <li aria-current="page">USC Founded; SSSA Established</li>
    </ol>
  </nav>
  <h1 class="lore-entry__title">USC Founded; Solar System Safety Standards Authority Established</h1>
  <p><span class="character-badge">~2340 UCSD</span></p>
</header>
