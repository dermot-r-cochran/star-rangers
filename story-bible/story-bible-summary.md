...
- **Multi-POV chapters.** Chapters are split into named POV blocks (e.g. `:::pov galahad`, `:::pov syra`, `:::pov rook`), each giving a different character's read on the same scene or sequence. The same event is deliberately shown from 2–3 angles per chapter.
- **Dry, documentary voice.** Prose favors precise, restrained diction over ornamentation — characters "file," "note," and "classify" as much as they feel. Emotional beats land through withheld information and procedural detail, not exposition.
- **Non-human POV as instrumentation.** Robot/AI POV (Rook-7) is rendered as literal log entries with timestamps, numbered observations, and flagged anomalies — a distinct register from the human/Krenyi prose.
- **Worldbuilding delivered as contested record.** Lore and history are written like in-universe scholarship, incident reports, and hearing transcripts, not narrator info-dumps. Institutional documents (the Codex) are primary sources with their own biases.
- **No magic, ever.** Anything that looks supernatural has a lawful, if not yet understood, mechanical explanation (Etheric pattern expression, boundary interference, Concordant overlap). This is a hard canon rule, stated explicitly in-chapter (see `canon_facts` in chapter front matter). Historical figures, legends, and in-universe characters may *believe* in magic, or reach for "magic," "curse," "blessing," "sorcery," or "prophecy" as a cognitive shorthand for higher-dimensional/Etheric phenomena they haven't correctly modeled — that belief and vocabulary is characterization and period-accurate voice (especially in the Codex and in older records), never a narration-level claim that magic is real. The prose itself never asserts magic as fact; it always resolves lawfully, even when a character or source doesn't know that.
- **No impartial narrator.** Every scene is carried by a specific character's subjective POV block — there is no floating, omniscient, "objective" narrative voice. The one exception is a passage explicitly framed as told from **Kieme's** perspective: Kieme is canon-established (see "The Cosmic Cascade and Kieme" below) as a non-anthropomorphic Upper-Structure origin tier, inferable only through invariants rather than a character with a stake in the scene — which is what makes an impartial register available there and nowhere else. A Kieme-perspective passage still can't break Kieme's own established constraints (no direct dialogue with time-bound entities, no selective intervention at the Material layer); use it for cosmic-scale framing, not for routinely resolving what a human POV can't see.
- **Understatement over drama.** Big reveals are delivered flatly ("She filed it. Not a threat. Information.") — tension comes from what's being tracked, not how it's announced.

---

## Braindump

A station clock has shown an impossible reading for eleven years, and nobody has been willing to close the file on why.
...
Threshold Station keeps logging the same impossible discrepancy — two chronometers, forty seconds apart, unresolved for eleven years — and the people sent to investigate it do not agree on what the record means.
...
### Cosmology — The Five Layers of Reality
Reality operates as five causal modes (not metaphorical planes), each with defined mechanisms, constraints, and observable effects:
1. **Spiritual** — origin condition, no agency; only inferred through invariants persisting across all Concordants.
2. **Conceptual** — identity/meaning structures before embodiment; produces stable meaning-pattern recurrence across cultures.
3. **Etheric** — rule-template layer constraining what physical expression can stay coherent; produces persisting pattern behavior after physical triggers are removed.
4. **Physical** — spacetime/fields/energy under Concordant boundary conditions; produces instrument drift near interfaces.
5. **Material** — matter, biology, tech, civilization; success correlates with "constraint literacy."

Cross-layer rule: no magic — every effect requires lawful coupling between layers. "Archetypal interference" (Etheric→Material transfer) is what un-literate observers mistake for the supernatural. Characters, cultures, and historical sources within the setting are free to use magical language — spells, curses, blessings, prophecy, sorcery, enchantment — as their own in-world vocabulary for Etheric or boundary phenomena they lack the instruments or theory to name correctly; this is period- and culture-accurate diction, not evidence that magic exists as a real force. Read the Codex accordingly: an "enchantment" reported in an old record is a claim to be cross-checked against the Five Layers model (what actually happened, mechanically), not a fact about the cosmology in its own right.

### Concordants and Boundary Zones
A **Concordant** (KON-kor-dant; plural **Concordance**) is a bounded region of reality with internally consistent physical and Etheric law, produced under Worldwright authority. Adjacent Concordants can meet at **boundary zones**, producing measurable instrument drift and "lawful disagreement, not law failure." Threshold Station and the Marsh Causeway both sit on boundary zones — this is *why* they're strategically/narratively important, not incidental set dressing.

### The Cosmic Cascade and Kieme
Above and prior to the Five Layers (which describe how phenomena at Threshold Station/Marsh Causeway resolve locally), a separate, higher-order hierarchy — the **Cosmic Cascade** — governs causal authority across the whole setting, all eras included: Hyperomnium → Kieme → Conseleme → Metawrights → Formwrights → Archewrights → Worldwrights → Universes with Concordants (Concordance) → Telearchs → Celestials (Frenar) → Levrils → Champions/Heroes. Causality resolves top-down only; no tier can override a higher one, and the Cascade encodes no moral cosmology. The top three tiers — Hyperomnium, Kieme, Conseleme, collectively "the Trinity" — are non-anthropomorphic origin conditions: no direct dialogue with time-bound entities, no selective intervention, inferable only through invariants that hold across every Concordant. **Kieme** specifically (legacy name: Holy Triumvirate) is Archive-credited, uneasily, with designing the one contested exception to that no-moral-cosmology rule — the Cosmic Limitation on Evil. Devotional/church-space tradition frames Kieme as a watching, sometimes-intervening presence; the Archive's canonical position is that Kieme is inferred from absence only, never witnessed directly. Both tellings are in-universe positions to be cross-checked, not settled canon fact about what Kieme experiences. Full detail: `src/lore/cosmic-cascade.md`, `src/glossary/kieme.md`, `src/lore/kieme-visible-hand.md`, `src/codex/cosmic-limitation-on-evil.md` (moved from `src/lore/` — see "Editorial note: lore vs. codex boundary, and spoiler discipline" below).
...
### Lifespan — who can span a century, and who cannot

Dermot, 13 August 2026: **"Only the Krenyi, the robots and some aliens would be that long-lived; none of the human characters live more than about 125 years."**

This is a hard continuity constraint, not a flavour note, and it is the one that decides where backstory can be set. The published seasons sit in **2822–2832**; the Founding Era sits in **2712–2723**. Those are **a hundred and three years apart**, which means:

- **No human can carry a *career* across both.** A child of the founding era is past a hundred and ten by Season 1 — inside the ceiling, but nobody holds a post for ninety years. So any human backstory belonging to a *serving* present-day character has to sit inside roughly the last fifty years.
- **A human witness to both eras is, just barely, possible.** Someone born in 2712 is 114 in 2826: alive, past the healthy window, and the only living person who was there. That is a narrow and expensive character to write, and precisely because it is narrow it is worth keeping in reserve rather than spending casually. It is available. It has not been used.
- **Machines and Krenyi can.** [Lucene-9000](/star-rangers/characters/lucene-9000/), Xenon and Lumbarian span whatever the story needs them to span; the Krenyi live centuries "without apparent degradation"; the Mnemari have no natural upper bound at all. When a story wants a witness who was present at both ends of the record, it has to be one of these — which is itself worth using rather than working around.
- **But the healthy span runs almost the whole way.** Dermot, 13 August 2026: **"medical technology and a fitness health mentality allows humans to delay the quality-of-life effects of ageing into their 11th decade."** So a human in this setting is not merely alive past a hundred — they are *capable* past a hundred: working, fit, undiminished in judgement. What 125 buys is not a long decline; it is a long competence followed by a short one. Write centenarians accordingly, and do not reach for the frailty shorthand a contemporary reader will expect.
...
Dermot, 13 August 2026: **"Another sci-fi and fantasy trope that I reject is inter-species mating and breeding, especially at Sapient level."** Written up as a **Bodies and Species** section on `src/lore/what-the-record-refuses.md`, plus two rows in that page's summary table, plus the Krenyi specifics on their own page.

- **The rule is general, not Krenyi-specific.** No sapient species in this record crosses with another: no half-human hybrids, no children of two peoples, no pending breakthrough. It is not squeamishness — it is the ordinary consequence of two lineages sharing no common ancestor, and therefore no chromosome count, no gene regulation, and no developmental sequence.
- **What the refusal buys.** Contact stories that have to find something else for two peoples to make together. The Four Islands relationship — years of translation, one standing delegation, nothing else — is the worked example already on the site.
- **The corollary worth protecting.** Cross-species attraction, where it happens, is a fact about a person and never a plot mechanism. It resolves nothing and bridges nothing.
- **The Krenyi specifics** (Dermot, same message): demisexual as a whole species, attraction only through an established bond; **they do not form romantic attachments to humans and will not consent to interbreed.** Stated once, plainly, not elaborated — *why not* asked of a Krenyi is usually the same question as *what are you, really*.
- **The biology, and its asymmetry.** Krenyi immunity destroys foreign genetic material outright, so human DNA entering a Krenyi never persists. Running the other way, **Krenyi blood is hazardous to a human**: transfused antibodies meet a body made entirely of foreign genetic material and do what they are for. The human survives and is seriously unwell for several days at minimum. The intuition here is wrong in a way that costs, which is why the record states it.
- **A quiet find while writing it.** The Krenyi page already listed "no flirtation or small talk, straight to material terms" as a separate trait. It was describing demisexuality without the word — there is no stage of a Krenyi relationship at which flirting would be doing anything. Similarly, human attraction to a Krenyi is generally the mythification problem in its most personal register: wanting the Quiet-Built rather than wanting *them*.

### The career ladder past active service — 55, the reserves, 75

Dermot, 13 August 2026, in two parts. First: **"Most Star Rangers can choose to retire on a full pension from age 75 onwards."** Then, correcting the reading that produced: **"If you meant becoming a planetary representative, the minimum recommended age is about 55 years, and they remain in the reserves until about 75."**

So there are **three stages, not two**, and the second one is the one that is easy to miss:

| Age | Status | Notes |
|---|---|---|
| ~55 | Planetary representative standing becomes available | Recommended floor, not a bar |
| ~55–75 | **On the reserve list** — left active service, *not* retired, still recallable | Two decades of the liaison role are performed by serving Rangers |
| ~75+ | Full pension, at the Ranger's own choosing | "Can choose" and "most" — the option opens, service need not end |
| **~110** | **Maximum retirement age — the one figure nobody negotiates** | Set where the eleventh decade's capability runs out, deliberately below the ~125 lifespan ceiling. Asteria left at about 100, holding Star Captain |

Set against the lifespan rule above, **a representative who begins at fifty-five may hold the standing for forty years or more** with undiminished judgement throughout.

- **It corrects a page that was already written.** [Retired Rangers: Liaisons, Representatives, and Recruiters](/star-rangers/lore/planetary-liaisons-and-recruiters/) argues the Corps' planetary relationships rest on retirees going home. That is right about the mechanism and wrong about the timing — the role starts twenty years before the pension. Section added there 13 Aug ("The Ages, and Why 'Retired' Is a Simplification"). **The page's title and its "Why It's a Post-Service Role" heading still lean on the word *retired*; whether to retitle it is Dermot's call, and I have not.**
- **The reserve stage sharpens the charter tension the page already raises.** A representative under seventy-five is not a private citizen with a service record — she is a serving Ranger living at home, on a world the charter forbids the Corps to enter. Nobody in-universe has made that argument formally. It is now available, and it is a good one.
- **It explains Brother Fintan.** *The Night Office* (S08E01C01) is a man who left thirty-one years of boundary-safety service and calls the hive-yard "the largest work he had ever held" — a second vocation with decades in it, not a wind-down. **Open question his numbers now raise:** thirty-one years' service plus roughly a decade on the hill. If he went at the full-pension age he joined at about forty-four, which is characterful but late; if he went earlier he left before the pension, which is permitted and means something. Worth deciding rather than leaving to arithmetic.
- **It is a career path, not a courtesy.** Dermot, same day: **"Planetary representation is also a non-command career path, similar to the technical career paths within each corps, with deepening specializations, certifications and medals as an alternative to rank progression or promotion."** So the Corps has **three** structures, not two: command, technical, and representational. The liaisons page said outright it was "not a fourth ladder" — that claim was wrong and has been rewritten ("A Career Path, and Not a Rank"), and `src/lore/star-rangers-command-hierarchy.md` gained a matching section, since it is the page that enumerates career structure and it still said "the two paths."
- **It is a corps, and it has a ceiling.** Dermot, same day: **"Star Ranger Liaison Corps (Planetary Representatives) and like police officers reassigned from dangerous front line work but still employed by the force."** So its members are serving Rangers on a posting, paid by the Corps — not veterans on an honorarium — and it carries everything *corps* means here: elected chapter leaders and a president, its own certifications, its own Academy college. It also has a second route in, unrelated to age: **reassignment off front-line work** when an injury or a condition ends boundary-proximate duty. Not a soft landing and never recorded as a demotion.
- **Correction, same session — I had this wrong twice.** I wrote that "a High Captain and a Chief who take it up on the same world start at the same standing." Dermot: **"Asteria was a High Captain at retirement and therefore too high ranking to be a Chief Liaison Officer,"** then **"or a Star Captain."** The corps' senior post is **Chief Liaison Officer**, a Chief's duty title beside Chief Ranger / Chief Pilot / Chief Provost / Chief Science Officer — so **an officer leaving at Star Captain or above is over-ranked for it and is not a candidate**, and the Corps declines to invent a grander title to fit a large career. Corrected on the liaisons page, the hierarchy page and Asteria's page. Below the bound, rank still does not transfer: two Chiefs on the same world start level.
- **Where flag-tier officers go instead is their own affair, and Asteria is the worked example.** She left at Star Captain, at about a hundred, for a Fellowship of Light chapter house as a Sage — an institution the Rangers do not run, whose whole standing rests on having renounced the interests everyone else keeps. Her existing page did not need its rank changed; it needed the closed door named.
- **The narrative consequence.** Leaving active service in this setting is a career change, not an ending. Any post-service character who reads as diminished is being written against the world.

### The Academy, and the open branch list

Dermot, 13 August 2026, proposing it: **"maybe the Star Rangers Academy for each corps and each branch within a corps?"** Written up as `src/lore/star-rangers-academy.md` — one institution, a college per corps, a school per branch. Not a fourth ladder: training was already guild property (`star-rangers-command-hierarchy.md` says the command ladder has no input into "guild and training functions"), and the Academy is just the largest instance of a rule that was already written. Instruction is a **posting held by serving officers**, not a career track, because a faculty of career instructors would within a generation be certifying field competence it had not recently held.

- **The Academy stops at Chief.** No college for command, no syllabus, no examination — certification is a claim other people can check, and command judgement is only ever verified by its consequences, usually too late to instruct. Above the hinge rank the mechanism becomes formal mentoring (below).
- **The branch list is open, permanently.** Dermot: **"The list of branches within each corps is open and can be filled out as needed by the narrative."** Stated on the page itself so no future session treats the enumeration as closed — a branch the record has not described is not thereby absent.
- **First named branch: Xenolinguistics, Survey Corps.** Its doctrine was already fully written across three pages and had no home: `what-the-record-refuses.md` refuses the universal translator outright and fixes the division of labour (the AI aligns corpora; the linguist decides meaning **and owns the error**, because a kernel-compliant mind will not claim a certainty about meaning it does not hold). Its two case studies were already on the site too — the Cerebraun three-part answer misfiled as evasion for a decade, and the Four Islands delegation still working a presumed-extinct language under Ilsabet Marrowtide's slow correction. Both are failures of patience rather than method, which is what the school is actually for.

### Breaks, sabbaticals, and early exits

Dermot, 13 August 2026: **"Early retirement and career breaks or extended sabbaticals are possible by negotiation and agreement, especially for health reasons, including stress related injuries."**

The ages above are the ordinary route, not the only one. Written up as a new section on `src/lore/star-rangers-command-hierarchy.md` ("Leaving, and Coming Back").

- **"A stress-related injury is an injury."** That is the whole posture, and it is consistent with an institution that certifies competence for a living: it has never found it coherent to rule a person unfit and then treat the finding as a character judgement. A break is a medical accommodation, not a favour and not a mark.
- **Negotiated, not granted.** Agreed between officer, chain of command, and — on medical ground — the Medical Corps, whose finding command cannot override, on the same guild-independence rule that stops a Starwarden revising a boundary standard.
- **It resolves the Fintan question raised above.** Thirty-one years' service and out before the pension age is an early retirement by agreement, which is now a documented route rather than an anomaly to be explained. A man who stood thirty years of watches over an instrument deck is exactly the profile the provision exists for. Nothing on his page needs changing; the arithmetic just stopped being a problem.
- **The corpus already dramatizes it, and nobody had named it.** S05E02C02 opens with Shepherd **"back on duty"** — she had been off it. Seasons 6 and 7 then run two chapters whose timestamps are *"Indeterminate. She has stopped trusting the count"* and *"Winter, she thinks. The edge is warm and that is the clock now."* That is a serving officer carrying something that has not finished with her, written long before there was a policy to file it under. Do not retrofit the policy into those chapters — they are better without it. The policy exists so the *institution* around them makes sense.
- **The line worth protecting.** The new section ends on it: coming back is not resumption, and the ones who have done it say the first ordinary morning back was harder than the incident that sent them away. That is the register the whole subject should keep — filed calmly, never performed.

**Check before dating any new backstory:** subtract from 2826 and add the character's age at the time. Under about 105, fine, and they can still be working. Over about 125, impossible. Between the two, they are alive and the story owes the reader a reason they are still on the page.

### Key locations
- **Threshold Station** — orbital station sitting on a Concordant boundary; Dock Seven has shown a 40-second chronometer discrepancy for 11 years, formally unresolved.
...
**Sir Galahad Thorne** — Human, Survey Team Lead at Threshold Station. Twelve years in the Survey Corps; reads every incident report chronologically, watching for what wasn't filed. Methodical without rigidity, cautious without fear. Refuses to name a pattern before data supports it — this makes him useful at the boundary and difficult in meetings expecting brief summaries. Worked with Krenyi before Syra. Title "Sir" is a still-technically-real territorial honor he uses without much care for what it signals.
...
**Mira of Brine** — Pelagene Littoral (ocean-world species), Environmental Surveyor. Built for buoyancy control and dissolved-oxygen variance; reads fluid motion (condensation, airflow vortices, coolant turbulence) as primary signal before it's classified as noise. Diagnoses leaks/vapor-creep/cross-medium contamination early because she's "listening to the station the way her body learned to listen to the sea."

**Qiren Tal** — Veyr Basaltborn (high-gravity volcanic homeworld), Hull Systems Specialist. Compact bone lattices, heat-tolerant skin; moves with calibration, not caution, in low-gravity. Trusts material resonance over display readouts until the two reconcile. Assigned to outer-ring hull junctions and thermal-risk zones precisely because that's where their specific training is useful. Good at catching seal fatigue/microfracture before it compounds into emergency-jump-triggering failure.

**Sethka Ru** — Serephine Dunekin (cold desert homeworld, thin atmosphere), Long-Range Scout. Light-scattering eye membranes, water-conservative metabolism. Plans movement around radiation profile, glare angle, thermal shadow *before* checking whether the social/mission plan can survive that physical reality — it often can't. Skeptical of any mission brief assuming stable conditions without measuring them ("*Assume stable* is not a methodology. It is a wish.").
...
| **Star Rangers (general)** — Founding Era, the Tissadelle arc, and any thread not named in this table | 500–900 words | ~1,100 | The main corpus's tier, one register up from Five-O: general readership. (Tier labels deliberately name readerships, not ages — the ladder children → young adult → general → contemplative carries the ascending-age meaning on its own, and "adult" was dropped 2026-08-04 for its unwanted content-rating connotation.) The band overlaps Five-O's at the bottom deliberately — the boundary between them is register and complexity, not a length cliff; what the extra headroom buys is the denser block when a scene earns it (Tissadelle's 1,164-word block in S02E02C01 is the corpus's longest and shows the ceiling being used). Recent practice (S6–S7 medians 486–653) sits comfortably inside; Season 1's shorter early blocks (median 383) predate the guideline and stand. |
| **Church Space** (contemplative) | 800–1,200 words | ~1,500 | Length earned only by reflective work. ~1,200 is roughly where a contemplative scene stops rewarding density even for a willing adult reader. |
...
### Character prominence: no tier taxonomy (settled 2026-08-03)

There is deliberately **no major/supporting/minor character hierarchy**. Three tier tags briefly existed (`major-character` on nine pages, `minor-character` on one, `supporting-character` on one — 11 of 59 character pages, never defined anywhere, with Wender and Sen untagged) and were removed 2026-08-03. They had exactly one consumer, found only when its check failed: `validate-content.js` required every chapter's resolved POVs to include a `major-character`-tagged page. That rule was retired with the tags — it was precisely the kind of global writing guidance the thread-relative point argues against, and it could only ever measure the tag, not the prominence. The 2-POV-minimum rule is separate and stays. The reason is structural, not tidiness: **prominence is a property of a (character, thread) pair** — major in one arc is supporting or minor in another — **and a front-matter tag is global by construction**, so it cannot hold a thread-relative answer without flattening it. Where "who matters here" legitimately lives: per-domain emphasis is the editions' hero cast in `lib/editions.js` (non-canonical by design); planning weight is re-derived by counts when needed (page length, named-in-N-files, chapters appeared in — see intake-2026-07-28 §6) rather than stored as labels that go stale; and a character page's own prose and `description` carry its narrative weight. Don't reintroduce tier tags.
...
## Glossary (key contested/in-universe terms)

- **Concordant** (KON-kor-dant, pl. Concordance) — a bounded region of reality with internally consistent physical/Etheric rules, produced under Worldwright authority.
- **Boundary zone** — where adjacent Concordants meet; produces measurable instrument drift and lawful (not failed) disagreement between local rule sets.
- **UCSD** — the setting's standard dating notation (United [Space] Consortium Stardate or equivalent); e.g. "2826 UCSD."
...
- **Cosmic Cascade** — the setting's full hierarchy of causal authority, from Hyperomnium down to Champions/Heroes; see "The Cosmic Cascade and Kieme" above.
- **Kieme** — second tier of the Cosmic Cascade (legacy name: Holy Triumvirate); a non-anthropomorphic origin condition, not a character with a POV in the ordinary sense. The one figure a scene's narration may be told "from the perspective of" while still reading as impartial rather than subjective.

---

## Editorial note: lore vs. codex boundary, and spoiler discipline

Two standing editorial rules, adopted 2026-07-18, for anyone (human or AI) drafting new `src/lore/`, `src/glossary/`, `src/codex/`, or `story-bible/` content:
...
3. **Some gaps are not withheld answers. They are the answer, and they never resolve.** Adopted 2026-08-13. The standing spoiler rule above assumes a mechanism exists and is being held back until the prose gets there. This third rule covers the opposite case, which is easy to mistake for the second and much easier to ruin: a gap the author has decided has no reveal behind it at all.
   ...
   - **Why this needs writing down.** An unexplained gap reads to any competent drafter — human or AI — as an unfinished job, and the honest instinct is to finish it. That instinct is the failure mode here. A reveal would not deepen the Krenyi; it would convert their central practice into a puzzle with a solution, which is the exact reduction the species is written to refuse. It would also break something structural: the Krenyi are the setting's demonstration that *declining to be placed* is a coherent position rather than an evasion. That only holds if the record never quietly proves them wrong.
   - **What is still permitted.** Characters may speculate, wonder, and be curious — in character, and unrewarded. A human who finds the gap frustrating is realistic and useful. What is forbidden is the narration confirming any of it, and any structure that frames the question as *open pending discovery* rather than *closed by the Krenyi*.
   - **How to spot another one.** Before "resolving" any long-standing absence in this setting, check whether the absence is doing work. If a page argues for why the gap exists, the gap is load-bearing and belongs to this rule, not to rule 2.
   - **The reason behind the silence, added the same day.** Dermot: **"The Krenyi are designed to focus on present and future and not the past unless it holds useful data."** This is the root the origin-silence grows from, and it generalises — a present-tense people have no use for being introduced by their past, mourn in a way that finishes, and greet each other with a marker meaning *still relevant here*. Written up as a new section on `src/lore/krenyi.md` ("The Present Tense, and What the Past Is For"), including the cost: they are poor keepers of anything whose value has not yet been demonstrated.
   - **Note the word "designed," and do not chase it.** Dermot's phrasing is *designed to*, and the species is called Quiet-Built after "their mode of self-construction." Whether that means engineered by someone or built by themselves is exactly the question the origin rule closes. Record the phrase; do not adjudicate it; do not let a drafter treat it as a thread.

## Source notes

Compiled from the live repository content on 2026-07-03: `src/index.md`, `src/about/index.md`, `src/lore/five-layers.md`, `src/lore/formation-of-star-rangers.md`, `src/glossary/concordant.md`, all files in `src/characters/`, all files in `src/timeline/` (excluding `index.md`), and `src/seasons/s01/e01/s01e01c01.md`. The "Narrative Structure — Multiple Independent Storylines" section was added 2026-07-13, formalizing a pattern read out of `src/seasons/s01/`, `src/seasons/s03/`, `src/seasons/s05/`, and `story-bible/tissadelle-arc-s6-7.md` rather than any single source file. On 2026-07-15, the no-magic rule was clarified across Style, Cosmology, Canon rules, and Glossary to state explicitly that in-universe belief in or talk of "magic" (by characters, legends, or historical/Codex sources) is allowed as voice and characterization, while the underlying mechanism must always resolve lawfully through the Five Layers/Concordant/Etheric model. The same pass added a "no impartial narrator except Kieme's perspective" rule (Style, Canon rules, Glossary) and a "Cosmic Cascade and Kieme" Worldbuilding subsection summarizing `src/lore/cosmic-cascade.md` and `src/glossary/kieme.md`, since the Kieme exception is otherwise unexplained in this document — no new setting facts were introduced in either case, only load-bearing existing canon made explicit for future drafting. Licensed CC BY-NC-ND 4.0 by Dermot R. Cochran — this summary is for personal drafting/import use, not redistribution.
